...
let addUploadFile = function() {
  ...
  if (!fs.existsSync(MIGRATIONS_DIR)) {
    ...
    fs.readdir(MIGRATIONS_DIR, (err, files) => {
      ...
      // Check that the mirgrations script doesn't already exist
      if(files.join('').match('_abi_analytics')) {
        ...
        console.log(`'X_abi_analytics.js' has already been added to your 'migrations' directory 😉`)
      }
    })
  }
}
